...
<main class="main">
    <header>
        ...
        <div class="pageName">
            <span>Withdraw <?= $_SESSION['login'] ?></span>
        </div>
        <div class="langs">
        ...
        <div class="panelTopline wDrawTopline">
            <div class="card cardPack">
                <div class="cardPack_top">
                    <div class="block">
                        <span class="textCommon textLight">Вывод средств</span>
                        <span class="textSmall textSecondary">Вывод средвст с кабинета на ваши счета</span>
                    </div>
                ...
                <div class="cardPack_bot">
                    ...
                    <button class="btnMain" onclick="postQuery('aForm', 'withdraw', 'wSumm.tron.tether')">
                        вывести
                    </button>
                </div>
            ...
            <div class="panelTopline_side wDrawTopline">
                ...
                <div class="card cardHigh cardDark">
                    <span class="textCommon textLight">Всего выведено</span>
                    <div class="cardPack_top">
